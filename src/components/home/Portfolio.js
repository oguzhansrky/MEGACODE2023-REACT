                                ...
                                <div className="swiper-slide">
                                    <div className="portfolio-card">
                                        ...
                                        <div className="info">
                                            ...
                                            <small className="d-block color-main text-uppercase"><a href="#">IT Consultation</a></small>
                                            <div className="text">
                                ...
                                <div className="swiper-slide">
                                    <div className="portfolio-card">
                                        ...
                                        <div className="info">
                                            ...
                                            <small className="d-block color-main text-uppercase"><a href="#">Website Development,</a> <a href="#">UI/UX Design</a></small>
                                            <div className="text">
                                                Trust our top minds to eliminate workflow pain points, implement new tech &amp; app.
                                            </div>
                                            <div className="tags">
                                ...
                                <div className="swiper-slide">
                                    <div className="portfolio-card">
                                        ...
                                        <div className="info">
                                            ...
                                            <small className="d-block color-main text-uppercase"><a href="#">Game Developemnt</a></small>
                                            <div className="text">
                                                Trust our top minds to eliminate workflow pain points, implement new tech &amp; app.
                                            </div>
                                            <div className="tags">
