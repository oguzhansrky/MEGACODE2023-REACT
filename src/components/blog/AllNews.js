                  ...
                  <div className="col-lg-7">
                    <div className="card-body p-0">
                      ...
                      <p className="fs-13px color-666">
                        ...
                        the way we work, it’s that will everyone [...]
                      </p>
                  ...
                  <div className="col-lg-7">
                    <div className="card-body p-0">
                      ...
                      <a
                        ...
                        className="card-title mb-10"
                      >
                        The New Trend Of Marketing With Tiktok, Should Or Not?
                      </a>
                      <p className="fs-13px color-666">
                        If there’s one way that wireless technology has changed
                        the way we work, it’s that will everyone [...]
                  ...
                  >
                    <div className="email-input d-flex align-items-center py-3 px-3 bg-white mt-3 radius-5">
                      ...
                      <input
                        ...
                        className="border-0 bg-transparent fs-13px"
                      />
                    </div>
