      ...
      children: (
        <div className="card-body ">
          <dl>
            ...
            <dd>{t("faq.software_dev_desc")}</dd>
          </dl>
          <dl>
            <dt>-{t("faq.software_dev_desc_title2")}</dt>
            <dd>{t("faq.software_dev_desc2")}</dd>
          </dl>
          <dl>
            <dt>- {t("faq.software_dev_desc_title3")}</dt>
            <dd>{t("faq.software_dev_desc3")}</dd>
          </dl>
          <dl>
            <dt>- {t("faq.software_dev_desc_title4")}</dt>
            <dd>{t("faq.software_dev_desc4")} </dd>
          </dl>
          <dl>
            <dt>- {t("faq.software_dev_desc_title5")}</dt>
            <dd>{t("faq.software_dev_desc5")}</dd>
          </dl>
        </div>
      ),
    },
      ...
      children: (
        <div className="card-body text-justify">
          <dl>
            ...
            <dd>{t("faq.web_design_desc")}</dd>
          </dl>
          <dl>
            <dt>- {t("faq.web_design_desc_title2")}</dt>
            <dd>{t("faq.web_design_desc2")}</dd>
          </dl>
          <dl>
            <dt>- {t("faq.web_design_desc_title3")}</dt>
            <dd>{t("faq.web_design_desc3")}</dd>
          </dl>
          <dl>
            <dt>- {t("faq.web_design_desc_title4")}</dt>
            <dd>{t("faq.web_design_desc4")}</dd>
          </dl>
        </div>
      ),
    },
      ...
      children: (
        <div className="card-body text-justify">
          <dl>
            ...
            <dd>{t("faq.mobil_app_dev_desc")}</dd>
          </dl>
          <dl>
            <dt>- {t("faq.mobil_app_dev_title2")}</dt>
            <dd>
              {t("faq.mobil_app_dev_list1")} =&gt; Swift, RxSwift, RxFlow, MVVM
            </dd>
            <dd>
          ...
          <dl>
            ...
            <dd>{t("faq.mobil_app_dev_desc3")}</dd>
          </dl>
          <dl>
            <dt>- {t("faq.mobil_app_dev_title4")}</dt>
            <dd>{t("faq.mobil_app_dev_desc4")}</dd>
          </dl>
        </div>
      ),
    },
      ...
      children: (
        <div className="card-body text-justify">
          <dl>
            ...
            <dd>{t("faq.commercial_desc")} </dd>
          </dl>
          <dl>
            <dt>- {t("faq.commercial_desc_title2")}</dt>
            <dd>{t("faq.commercial_desc2")}</dd>
          </dl>
          <dl>
            <dt>- {t("faq.commercial_desc_title3")}</dt>
            <dd>{t("faq.commercial_desc3")} </dd>
          </dl>
          <dl>
            <dt>- {t("faq.commercial_desc_title4")}</dt>
            <dd>{t("faq.commercial_desc4")}</dd>
          </dl>
        </div>
      ),
    },
