              ...
              <div className="col-lg-8">
                ...
                <div className="blog-content-info">
                  <h4 className="fw-bold color-000 lh-4 mb-30">
                    ...
                    {"{"}" "{"}"}
                    <a href="#" className="color-blue5">
                      Moussa
                    </a>
                    {"{"}" "{"}"}
                    and German studio Schultzschultz have created The Lodge
                    Wooden at Berlin City
                  </h4>
                  <div className="text mb-10 color-666">
                    ...
                    one day getting that big promotion.
                  </div>
                  <div className="text color-666 mb-20">
                    Coventry is a city with a thousand years of history that has
                    plenty to offer the visiting tourist.{"{"}" "{"}"}
                    <br /> Located in the heart of Warwickshire.
                    <br />
                  </div>
                  ...
                  <div className="text mt-50 color-666">
                    The short answer is yes. According to Kross, when you think
                    of yourself as another person, it allows you lorem ispum
                    lorem suo give yourself more. Notre dame at sume lorem
                  ...
                  <div className="twitter-info mt-60">
                    <div className="twitter-card">
                      ...
                      <div className="twitter-info mt-40">
                        <h5>
                          ...
                          {"{"}" "{"}"}
                          is incredibly dedicated, knowledgeable, and helpful.
                          The finished product was beautiful, and worth every
                          penny. I would absolutely recommend Iteck WP Theme.”
                        </h5>
                      </div>
                    </div>
                    ...
                    <div className="text color-666 mt-30">
                      ...
                      banjo before they sold out blog photo booth Marfa semio
                      tics Truffaut. Mustache Schlitz next level blog
                      Williamsburg, deep v typewriter tote bag
                    </div>
                    <ul className="ps-1 ps-lg-5 my-4 color-666 fs-14px lh-7">
                      <li className="d-flex">
                        <i className="bi bi-dot me-2 fs-3 lh-2 pt-1" />
                    ...
                    <div className="text color-666 mt-30">
                      ...
                      <a
                        href="#"
                        className="text-decoration-underline color-blue5"
                      >
                        my fondest
                      </a>
                      {"{"}" "{"}"}
                  ...
                  <div className="blog-comments mt-70">
                      ...
                      <div className="d-flex">
                        ...
                        <div className="inf">
                          ...
                          <div className="text color-000 fs-12px mt-10">
                            ...
                            laborum sed ut perspiciatis unde. Lorem ispum dolor
                            sit amet
                          </div>
                    ...
                    <div className="comments-content mt-70">
                      <h3 className="color-000 mb-0"> 02 Comments </h3>
                      <div className="comment-replay-cont border-bottom border-1 brd-gray pb-40 pt-40">
                        ...
                        <div className="d-flex comment-replay ps-5 mt-30 ms-4">
                          ...
                          <div className="inf">
                            <div className="title d-flex justify-content-between">
                              <h6 className="fw-bold fs-14px">Tobey McGuire</h6>
                              <span className="time fs-12px text-uppercase">
                                2 dayes ago
                              </span>
                            </div>
                ...
                <div className="side-blog style-5 ps-lg-5 mt-5 mt-lg-0">
                  ...
                  <div className="side-newsletter mb-50">
                    ...
                    >
                      ...
                      <button className="btn bg-blue5 sm-butn text-white hover-darkBlue w-100 mt-3 radius-5 py-3">
                        <span>Subscribe</span>
                      </button>
                    </form>
                  </div>
